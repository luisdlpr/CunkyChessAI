...
import pygame_textinput as t

pygame.init()

# No arguments needed to get started
textinput = t.TextInputVisualizer()

# But more customization possible: Pass your own font object
font = pygame.font.SysFont("Consolas", 55)
# Create own manager with custom input validator
manager = t.TextInputManager(validator = lambda input: len(input) <= 5)
# Pass these to constructor
textinput_custom = t.TextInputVisualizer(manager=manager, font_object=font)
# Customize much more
